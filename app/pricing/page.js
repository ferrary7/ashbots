    ...
    const tiers = [
        {
            ...
            demoLink: 'https://creator.voiceflow.com/share/6849fb64cbc50d231af2dd7d/development'
        },
        {
            name: 'Premium',
            price: '$299 one-time',
            ...
            demoLink: 'https://creator.voiceflow.com/share/694ebb90f022b1214650bbf2/development'
        }
    ]
        ...
        <div className="bg-white min-h-screen">
            <section className="pt-64 pb-32 px-6 lg:px-12 bg-soft-mesh relative border-b border-slate-50">
                ...
                <div className="max-w-7xl mx-auto text-center space-y-8 animate-fade-in relative z-10">
                    ...
                    <p className="text-lg font-light text-slate-700 max-w-2xl mx-auto leading-relaxed">
                        ...
                        {tiers.map((tier, idx) => (
                            <div key={idx} className="group p-12 rounded-[3rem] border border-slate-100 bg-white transition-all duration-700 hover:shadow-premium-hover hover:-translate-y-2 flex flex-col justify-between relative overflow-hidden">
                                ...
                                <div className="relative z-10 space-y-10">
                                    ...
                                    <p className="text-sm font-light text-slate-700 leading-relaxed italic border-l border-slate-100 pl-6">{tier.desc}</p>

                                    <div className="space-y-5">
                                        <div className="flex items-center space-x-4">
                                            <span className="text-[10px] font-semibold uppercase tracking-[0.1em] text-slate-500">Inclusions</span>
                                            <div className="h-px flex-grow bg-slate-50"></div>
                                        </div>
                                        {tier.features.map(f => (
                                            <div key={f} className="flex items-start space-x-3 text-sm font-light text-slate-600">
                                ...
                                <div className="relative z-10 pt-12 space-y-6">
                                    <p className="text-[10px] font-medium text-slate-500 uppercase tracking-widest text-center border-t border-slate-50 pt-8">{tier.note}</p>
                                    <Button href={tier.demoLink} target="_blank" variant="primary" className="w-full shadow-sm">
                                        View demo
                                    </Button>
                                </div>
                            </div>
